...
void main()
{
  char Name[50][40] = {"Sam Matthews", "Mary McBeth", "Ying Phakpon","Chai Chanchai", "Yong Boonsith", "Kitti Karndee"};
  int ID[50] = {5301, 5302, 5303, 5304, 5305, 5306};
  float GPA[50] = {2.73, 2.35, 3.65, 3.24, 1.32, 3.26};
  int N = 6, i;
